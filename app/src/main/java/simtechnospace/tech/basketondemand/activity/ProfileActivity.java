...
public class ProfileActivity extends AppCompatActivity {
        ...
        protected void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            mBtnSignup.setText("Update Profile");


            String name[] = mLoginUserDetails.getNameDisplay().split(" ");;

            mEdtUserName.setText(mLoginUserDetails.getEmail());
            mEdtUserAddress.setText(mLoginUserDetails.getAddress());
            mEdtUserFirstName.setText(name[0]);
            mEdtUserLastName.setText(name[1]);
        ...
        public void submitForm(String firstname, String lastname, String mobileNo, String userName, String password, String address) {
            ...
            if (!checkFirstName(firstname)) {
                ...
                try {
                    ...
                    mLoginUserDetails.setNameDisplay(firstname+" "+lastname);
                    mLoginUserDetails.setMobileNo(mobileNo);
                    mLoginUserDetails.setAddress(address);
                ...
                String url = URLClass.profileUpdateUrl;
